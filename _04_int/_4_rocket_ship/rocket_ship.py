...
def mouse_pressed(event):
    ...
    # of a triangle
    points = [x, y, x+150, y+150, x-150, y+150]
    rocket = canvas.create_polygon(points, fill='gray', width=2) # draws triangle
    rocket = canvas.create_oval(x, y+300, x+50, y+150, fill='orange')
    rocket = canvas.create_oval(x, y + 300, x - 50, y + 150, fill='orange')
